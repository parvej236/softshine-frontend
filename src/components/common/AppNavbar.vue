...
<div class="mt-auto pt-8 border-t border-white/5 stagger-item">
  ...
  <div class="grid grid-cols-3 gap-3 mb-6">
    <a v-for="social in socialLinks" :key="social.name" 
      ...
      <span class="text-[8px] font-black uppercase tracking-widest text-slate-500 group-hover:text-white transition-colors">
        {{ social.name }}
      </span>
    </a>
  </div>
  ...
  <a href="tel:+8801604490060" 
    ...
    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      <path d="M6.62 10.79a15.15 15.15 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.27 11.72 11.72 0 003.7.59 1 1 0 011 1V20a1 1 0 01-1 1A15 15 0 013 6a1 1 0 011-1h3.41a1 1 0 011 1 11.72 11.72 0 00.59 3.7 1 1 0 01-.27 1.1l-2.11 2.09z"/>
    </svg>
    Call Directly
  </a>
</div>
