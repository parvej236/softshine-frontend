    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
      ...
      <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 border-b border-white/5 pb-8">
        ...
        <div
          ...
          <button v-for="tab in ['All', 'Ecommerce', 'LMS', 'AI', 'Blog', 'Portfolio', 'Other']" :key="tab"
...
const projects = ref([
  ...
  { id: 6, title: 'DigitalWorld', category: 'Ecommerce', status: 'Live', image: new URL('@/assets/projects/ecom-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/ecom-main.png', import.meta.url).href, new URL('@/assets/projects/ecom-1.png', import.meta.url).href, new URL('@/assets/projects/ecom-2.png', import.meta.url).href], description: 'Job board for Vue developers.', tags: ['Vue 3', 'Node.js', 'Express'], liveUrl: 'https://vuecrudproject.netlify.app' },
