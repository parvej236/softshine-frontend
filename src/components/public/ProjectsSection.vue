...
const projects = ref([
  { id: 1, title: 'Taraban', category: 'Ecommerce', status: 'Live', image: new URL('@/assets/projects/taraban-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/taraban-main.png', import.meta.url).href, new URL('@/assets/projects/taraban-1.png', import.meta.url).href], description: 'Headless e-commerce engine with MedusaJS and Next.js 14.', tags: ['MedusaJS', 'Next.js', 'Stripe'], liveUrl: 'https://taraban.netlify.app' },
  { id: 2, title: 'Amrapari', category: 'LMS', status: 'Active', image: new URL('@/assets/projects/amrapari-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/amrapari-main.png', import.meta.url).href, new URL('@/assets/projects/amrapari-1.png', import.meta.url).href], description: 'Multi-tenant ERP with modular billing and logistics modules.', tags: ['Vue 3', 'Spring Boot', 'PostgreSQL'], liveUrl: 'https://amrapari2-qcsc.netlify.app' },
  { id: 3, title: 'Grab All', category: 'Ecommerce', status: 'Testing', image: new URL('@/assets/projects/graball-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/graball-main.png', import.meta.url).href, new URL('@/assets/projects/graball-1.png', import.meta.url).href], description: 'IoT biometric system with real-time cloud dashboard.', tags: ['Arduino', 'C++', 'IoT'], liveUrl: 'https://graball.sellbd.shop' },
  { id: 4, title: 'Softshine', category: 'Portfolio', status: 'Dev', image: new URL('@/assets/projects/softshine-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/softshine-main.png', import.meta.url).href], description: 'Wholesale B2B platform with tiered pricing logic.', tags: ['Next.js', 'Prisma', 'PostgreSQL'], liveUrl: 'https://softshine-frontend.netlify.app' },
  { id: 5, title: 'Robotest', category: 'Other', status: 'Archive', image: new URL('@/assets/projects/robotest-main.png', import.meta.url).href, gallery: [new URL('@/assets/projects/robotest-main.png', import.meta.url).href], description: 'Rigid-body physics engine for exhibition displays.', tags: ['Matter.js', 'Canvas', 'Electron'], liveUrl: 'https://robo236.netlify.app' },
